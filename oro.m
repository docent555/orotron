...
ZAxis(:,1) = IN.ZAxis;
TAxis(:,1) = IN.TAxis;
lHandleB = IN.lHandleB;
lHandleJ = IN.lHandleJ;
...
OUT.ExecutionTime = toc(timerVal);

fprintf("ExecitionTime = %8.4f [s]\n", OUT.ExecutionTime);
% app.ExecutionTimeLabel.Text = sprintf('ExecutionTime =%8.4f', OUT.ExecutionTime);
